...
bearer token, reject noncanonical or unsupported payloads, and require two
additional P-256 keys with different identifiers and public points:
...
This signer is deliberately stateless. It proves that every client and backend
