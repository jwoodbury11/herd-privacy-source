...
export type HerdBindings = {
  ...
  HERD_TEST_BYPASS_ENABLED?: string;
  HERD_ALLOW_INSECURE_QA_BYPASS?: string;
  HERD_QA_BYPASS_GENERATION?: string;
  HERD_QA_RESET_ENABLED?: string;
  HERD_TEST_PHONE_E164?: string;
  HERD_TEST_HOST_PHONE_E164?: string;
  ...
  HERD_SOFTWARE_QA_LOCAL_TRUST_SIGNER_ENABLED?: string;
